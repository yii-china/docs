...
我们根据 [Yii 文档条款](https://www.yiiframework.com/license#docs) 发布本指南。
...
- [您需要了解什么？](start/prerequisites.md)
...
- [应用程序结构概述](structure/overview.md)
- [入口脚本](structure/entry-script.md)
- [应用程序](structure/application.md)
- [服务组件](structure/service.md)
- [操作](structure/action.md)
...
- [控制台应用程序](tutorial/console-applications.md)
- [国际化](tutorial/i18n.md) TODO
- [邮件发送](tutorial/mailing.md)
